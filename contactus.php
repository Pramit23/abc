...
<div class="wrapper col4">
  <div id="container">
    <h6>Our Address</h6>
    <p>
Online Hospital Management System , 19 R N Mukherjee 3rd Floor, Kolkata 700055 ,India <br />

<strong>tel</strong>:+91 6291045632 <br />

<strong>Email ID</strong>: info@srijontechnologies.com</p>
        ...
        <h6>Contact Us </h6>
          ...
          <p>
             <textarea name="comment" id="comment" cols="100%" rows="10" placeholder="Comment Required"></textarea>
...
function sendmail($toaddress,$subject,$message)
{
	...
	$mail = new PHPMailer; //defined new object PHPMailer
